                    ...
                    <table>
                        ...
                        <?php
                            ...
                            while($row = $result->fetch_assoc()) {
                                echo "<tr><td>" . $row["first_name"]. "</td><td>" . $row["last_name"]."</td><td>" . $row["flight_id"]."</td><td>" . $row["seats_to_book"]. "</td><td>" . $row["email"]. "</td><td>" . $row["phone"]. "</td><td>" . $row["address1"]. "</td><td>" . $row["address2"]. "</td><td>" . $row["city"]. "</td><td>" . $row["state"]. "</td><td>" . $row["postal_code"]. "</td><td>" . $row["country"]. "</td><td>" . $row["birth_year"]. "</td><td>" . $row["about_you"]. "</td><td>" . $row["consent"]. "</td></tr>";
                            }
                            } else {
